...
vehicles = {
    [`code3fpis`] = { -- These are examples, please edit these and add your own vehicles
        name = "Response Car",
        boneName = "engine",
        offSet = {0.0, 0.76, -0.4},
        rotation = {0.0, 0.0, 0.0},
    },
	[`code318charg`] = { -- These are examples, please edit these and add your own vehicles
        name = "Response Car",
        boneName = "engine",
        offSet = {0.0, 0.76, -0.4},
        rotation = {0.0, 0.0, 0.0},
    },
	[`code398cvpi`] = { -- These are examples, please edit these and add your own vehicles
        name = "Response Car",
        boneName = "engine",
        offSet = {0.0, 0.76, -0.4},
        rotation = {0.0, 0.0, 0.0},
    },
	[`HellcatRed`] = { -- These are examples, please edit these and add your own vehicles
        name = "Response Car",
        boneName = "engine",
        offSet = {0.0, 0.76, -0.4},
        rotation = {0.0, 0.0, 0.0},
...
grapplerCommand = {
    ...
    ESX = {
        ...
        checkJob = {
            ...
            jobs = {"police", "mechanic"} -- A user can have any of the following jobs, allowing you to add multiple
        }
    },
